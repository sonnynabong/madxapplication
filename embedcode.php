            ...
            <div class="col-md-12">
                <form id="meta-title-form" class="card p-4 shadow-sm">
                    <div class="mb-3">
						...
						<span style="display: block;font-size: 14px;padding-bottom: 10px">Enter the main keywords Kyou want to focus on for your page.</span>
                        <input type="text" id="keyword" name="keyword" class="form-control" placeholder="Easy Weeknight Dinner Recipes" required>
                    </div>

                    <div class="mb-3">
                        <label for="type" class="form-label">Type:</label>
						<span style="display: block;font-size: 14px;padding-bottom: 10px">Select the type of page you're creating</span>
                    ...
                    <div class="d-grid" id="meta-title-result">
    ...
    <script>
        document.getElementById('meta-title-form').addEventListener('submit', function(event) {
            ...
            .then(data => {
                ...
                // Update the meta-title-result div with the meta title
                document.getElementById('meta-title-result').textContent = metaTitle;
            })
            .catch(error => {
